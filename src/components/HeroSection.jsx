...
const PLANET_ASSETS = [
  ...
  { texture: '/images/planet_lava.png', color: '#ffaa00', size: 1.2, radius: 9, inclination: 0.5, speed: 0.3 },
  { texture: '/images/planet_void.png', color: '#ddccff', size: 0.7, radius: 11, inclination: -0.6, speed: 0.25 },
  { texture: '/images/planet_forest.png', color: '#aaffaa', size: 0.9, radius: 13, inclination: 0.8, speed: 0.2 },
  { texture: '/images/planet_gas.png', color: '#ffccaa', size: 1.1, radius: 15, inclination: -0.4, speed: 0.18 },
  { texture: '/images/planet_desert.png', color: '#ffeeaa', size: 0.7, radius: 17, inclination: 0.6, speed: 0.15 }
];
